...
if(use_wmv)
	%vid = mmreader(['../data/' videoName '.wmv']);
     vid = VideoReader(['C:/Users/risha/Desktop/ETH/sem1/CV/Lab/codes/Lab_assignment_11/CV_Exercise_11_Revised/data/' videoName '.wmv']); 
else
    vid = aviread(['C:/Users/risha/Desktop/ETH/sem1/CV/Lab/codes/Lab_assignment_11/CV_Exercise_11_Revised/data/' videoName '.avi']);
end
